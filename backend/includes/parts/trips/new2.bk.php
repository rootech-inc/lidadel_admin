<div class="container-fluid p-2 h-100 custom_shadow overflow-hidden">
    <form id="upload_file_form" class="row no-gutters h-100 overflow-hidden" method="post" action="backend/process/form.php" enctype="multipart/form-data">
        <input type="hidden" name="function" value="general_event">
        <!-- EVENT DESCRIPTION -->
                    ...
                    <div class="w-100 h-100 d-flex flex-wrap align-content-between">
                        ...
                        <div class="h-25 w-100 card shadow-sm">
                            ...
                            <div class="card-body p-1">
                                <input value="<?php echo get_session('adult') ?>" type="number" step="any" name="adult" class="form-control h-100 font-weight-bolder" placeholder="amount for adults" required>
                            </div>
                        </div>
                        ...
                        <div class="h-25 w-100 card shadow-sm">
                            ...
                            <div class="card-body p-1">
                                <input value="<?php echo get_session('couple') ?>" type="number" step="any" name="couple" class="form-control h-100 font-weight-bolder" placeholder="amount for couple">
                            </div>
                        </div>
                        ...
                        <div class="h-25 w-100 card shadow-sm">
                            ...
                            <div class="card-body p-1">
                                <input <?php echo get_session('kids') ?> type="number" step="any" name="kids" class="form-control h-100 font-weight-bolder" placeholder="amount for kids">
                            </div>
                        </div>
